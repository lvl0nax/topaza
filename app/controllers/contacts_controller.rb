class ContactsController < ApplicationController
  def index
    @contacts = [{city: 'Москва', name: 'Салон &laquo;KATRIN&raquo;', address: 'ул.Поварская д.35/28', tel: '(495) 691-61-69', time: 'Пн-Вс: <b>11:00 - 21:00</b> (без выходных)', site: 'www.katrin.ru', text: 'Предварительная запись'},
                 ...
                 {city: 'Москва', name: 'Креативный свадебный<br>шоу-рум &laquo;WHITE CHICKS&raquo;', address: 'ул.Бол.Новодмитровская, д.36/4 стр.2', tel: '8(499) 39-101-59', time: 'Пн-Вс: <b>10:00 - 20:00</b> (без выходных)', site: 'www.whitechicks.ru', text: 'Предварительная запись'},
